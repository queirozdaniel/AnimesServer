    ...
    private fun findHeroes(query: String?): List<Hero> {
        ...
        return if(!query.isNullOrEmpty()) {
            ...
            heroes.forEach {
                (_, heroes) ->
                heroes.forEach {
                    hero -> if (hero.name.lowercase().contains(query.lowercase())){
                        founded.add(hero)
                    }
                }
            }
